...
?>
	...
	<div class="container">
		<a href="private.php" class="navbar-brand">VOGUE LIFESTYLE</a>
		<ul class="navbar-nav  ms-auto">
    	  	
    	  	<li class="nav-item">
    	  		<a href="private.php" class="nav-link">Add Product</a>
    	  	</li>
    	  	<li class="nav-item">
    	  		<a href="private1.php" class="nav-link">Contact Table</a>
    	  	</li>
    	  	<li class="nav-item">
    	  		<a href="admin.php?logout=<?php echo $admin; ?>"  onclick="return confirm('are your sure you want to logout?');" class="nav-link">Log Out</a>
    	  	</li>
    	  </ul>     
  </div>
...
<form class="mt-5" action="" method="post" enctype="multipart/form-data">
  ...
  <button type="submit" value="add the product" name="add_product" class="btn btn-dark mt-2">Add Product</button>
</div>
</form>
<div class="mt-5">
<table class="table">
