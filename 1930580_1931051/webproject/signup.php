<?php
 ...
 if (isset($_POST['submit'])) {
 	...
 	if ( mysqli_num_rows($select)>0 ) {
         ...
         mysqli_query($conn, "INSERT INTO `user` (firstname, lastname, email, username, password, password1, address, city) VALUES ('$firstname', '$lastname', '$email', '$username', '$password', '$password1', '$address', '$city');") or die('query Failed');
...
<body>
	...
	<div class="container">
		<a href="index.php" class="navbar-brand">VOGUE LIFESTYLE</a>
