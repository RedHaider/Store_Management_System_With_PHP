...
<h3>Cart</h3>
  ...
  <tbody>
    <tr>
      ...
      <td>
      	<a href="cart.php?remove=<?php echo $fetch_cart['id']; ?>" onclick="return confirm('remove item from cart?')" class="delete-btn"><button type="button" class="btn btn-danger">Remove</button></a></td>
    </tr>
    <?php
    $final_total += $total; 
    	}
   ...
   <tr class="table-bottom">
      <td><a href="datalisting.php"><button type="button" class="btn btn-light">continue shopping</button></a></td>
...
<div class="footer mb-5">
	<footer class=" p-3 mb-5 bg-dark text-white text-center ">
 <div class="container">
